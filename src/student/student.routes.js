...
studentRouter.get("/certificate", studentController.getCertificate);
studentRouter.post("/certificate",studentController.addNewCertificate)

studentRouter.get("/analytics",authMiddleware,studentController.getMonthlyStats );
